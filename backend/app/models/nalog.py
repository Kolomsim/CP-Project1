...
class NalogCompanyInfo(BaseModel):
    ...
    okved: Optional[str] = Field(None, description="Основной вид деятельности (ОКВЭД, название)")
    okved_code: Optional[str] = Field(None, description="Код основного вида деятельности (ОКВЭД)")
