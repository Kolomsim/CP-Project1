		...
		>
			<Container size='lg'>
				<Stack gap={32} style={{ maxWidth: 720, margin: '0 auto', alignItems: 'center', textAlign: 'center' }}>
					...
					>
						СмартЧек — помогаем найти скрытые риски в сделках с недвижимостью. Проверьте объект, продавца и документы за
						короткий срок. Безопасная покупка начинается здесь.
					</Text>
