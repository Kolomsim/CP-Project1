...
import { AppShell, Badge, Container, Group, Stack, Text, Title, UnstyledButton } from '@mantine/core'
		...
		<AppShell header={{ height: 64 }} padding='md'>
			<AppShell.Header>
				<Group h='100%' px='md' justify='space-between'>
					<Text component={Link} to='/' fw={600} size='lg' style={{ textDecoration: 'none', color: 'inherit' }}>
