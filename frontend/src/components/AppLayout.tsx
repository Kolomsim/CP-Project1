		...
		<AppShell header={{ height: 64 }} footer={{ height: 'auto' }} padding='md'>
			...
			<AppShell.Footer p='md' style={{ position: 'relative' }}>
				...
				<Text size='xs' c='dimmed' ta='center'>
					Информация, размещённая на данном сайте, носит исключительно общий
					информационный и справочный характер, не является юридической
					консультацией, заключением специалиста либо индивидуальной
					рекомендацией, направленной на принятие конкретного решения в
					отношении Вашей ситуации.
				</Text>
			</AppShell.Footer>
		</AppShell>
	)
